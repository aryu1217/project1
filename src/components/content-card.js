...
export default function ContentCard({ title, imagePath, ranking }) {
  return (
    <div className="bg-gray-800 rounded-lg p-4 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 w-[260px] h-[410px] flex-col relative">
      {ranking === 0 && (
      ...
      {/* {ranking === 3 && (
        <div className="absolute top-[-10px] left-[-15px] text-gray-400 text-[40px] font-bold rounded-full w-10 h-10 flex items-center justify-center z-10 shadow-2xl">
          4
        </div>
      )}
      {ranking === 4 && (
